...
@XmlType(propOrder = {"boardId", "boardType", "rplyIndc", "cmntIndc", "atchIndc", "evalIndc", "validTermIndc", "validTermCode", "anonyIndc", "anceIndc", "apprIndc", "typeCode1", "typeCode2", "typeCode3", "typeCode4", "useIndc", "entrOpenIndc", "crtDate", "crtId", "chngDate", "chngId"}) 
@AutoProperty 
