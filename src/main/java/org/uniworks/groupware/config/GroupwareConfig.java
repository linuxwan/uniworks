...
import org.uniworks.groupware.common.FileDownloadView;
import org.uniworks.groupware.common.util.ApplicationConfigReader;
import org.uniworks.groupware.intercept.SessionCheckInterceptor;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = { "org.uniworks.groupware.controller"}, useDefaultFilters = false, includeFilters = { @Filter(Controller.class),  @Filter(ControllerAdvice.class) })
@PropertySource(value = "classpath:application.properties")
@Import({SecurityConfig.class})
public class GroupwareConfig extends WebMvcConfigurerAdapter {
	...
	//결재문서 Validator
	@Bean(name = "approvalDocValidatorA")
	public ApprovalDocValidatorA approvalDocValidatorA() {
		return new ApprovalDocValidatorA();
	}
	
	//파일 다운로드를 위한 FileDownloadView
	@Bean
