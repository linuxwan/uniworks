...
public class Nw030m implements Serializable {  
	...
	private Timestamp cntnRgsrDate; 
	private String cntnRgsrId; 
	private Timestamp cntnChngDate; 
	...
	public void setCntnRgsrDate(Timestamp cntnRgsrDate) { 
		this.cntnRgsrDate = cntnRgsrDate; 
	} 
	public Timestamp getCntnRgsrDate() { 
	...
	public void setCntnChngDate(Timestamp cntnChngDate) { 
		this.cntnChngDate = cntnChngDate; 
	} 
	public Timestamp getCntnChngDate() { 
